...
1. **Class Name**: The identity of the domain entity.
2. **Responsibilities**: The specific behaviors the class is **engineered** to perform.
3. **Collaborators**: The list of associated classes it must **partner** with to fulfill its role.
